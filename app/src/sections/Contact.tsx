...
export function Contact() {
  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'kshatriyautkarsh404@gmail.com',
      href: 'mailto:kshatriyautkarsh404@gmail.com',
    },
    {
      icon: Phone,
      label: 'Phone',
  ...
  const socialLinks = [
    { icon: Linkedin, href: 'https://www.linkedin.com/in/utkarshsingh1801', label: 'LinkedIn' },
    { icon: Github, href: 'https://github.com/UtkarshSingh-1', label: 'GitHub' },
  ];
          ...
          >
            ...
            <Card3D glowColor="magenta" intensity={8}>
              <div className="flex items-center gap-4">
                <div className="relative">
                  <div className="w-4 h-4 bg-cyan rounded-full" />
                  <div className="absolute inset-0 bg-cyan rounded-full animate-ping" />
                </div>
                <div>
                  <p className="text-white font-medium">
                    AKTU Computer Science student
                  </p>
                  <p className="text-sm text-white/50">Specializing in scalable systems</p>
                </div>
              </div>
            </Card3D>
          </motion.div>
