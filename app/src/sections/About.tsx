...
const highlights = [
  ...
  },
  {
    icon: Briefcase,
    title: 'Availability',
    description: 'Freelance-Ready',
    color: 'magenta' as const,
  },
  {
    icon: Database,
    title: 'Expertise',
    description: 'MERN, ML, Databases',
    color: 'cyan' as const,
  },
];
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <p className="text-white/70 leading-relaxed mb-4">
                    I&apos;m a Computer Science undergraduate with a deep passion for building
                    innovative web applications. My journey in tech started with curiosity
                    and has evolved into a career focused on creating impactful digital
                    experiences.
                  </p>
                  <p className="text-white/70 leading-relaxed">
                    With expertise in the MERN stack, machine learning, and database
                    management, I bring a holistic approach to every project. I believe in
                    writing clean, maintainable code and creating user-centric designs that
                    make a difference.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/50 text-sm">
                      Currently exploring advanced AI/ML integrations and cloud
                      architectures to deliver cutting-edge solutions.
                    </p>
                  </div>
                </div>
              </Card3D>
