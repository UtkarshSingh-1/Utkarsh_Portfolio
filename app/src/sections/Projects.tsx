...
const projects = [
  {
    ...
    title: 'PG Life',
    description:
      'A comprehensive platform for finding and booking PG accommodations. Features include advanced search filters, real-time availability, secure payments, and a user-friendly interface for both tenants and property owners.',
    image: '',
    tech: ['React', 'Node.js', 'MongoDB', 'Express', 'Redux', 'JWT'],
    liveUrl: 'https://pg-life-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/pglife',
    featured: true,
  },
  {
    id: 2,
    title: 'Job Portal',
    description:
      'Full-featured job portal built with MERN stack. Includes job posting, application tracking, resume builder, AI-powered job matching, and real-time notifications for both employers and job seekers.',
    image: '',
    tech: ['React', 'Node.js', 'MongoDB', 'Express', 'Socket.io', 'Cloudinary'],
    liveUrl: 'https://job-portal-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/job-portal',
    featured: true,
  },
  {
    id: 3,
    title: 'IPO Web App',
    description:
      'Developed during internship at Bluestock Fintech. A comprehensive IPO tracking and analysis platform with real-time data, historical analysis, and predictive insights for investors.',
    image: '',
    tech: ['Next.js', 'Node.js', 'PostgreSQL', 'Redis', 'Chart.js', 'REST APIs'],
    liveUrl: 'https://ipo-webapp-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/ipo-webapp',
    featured: true,
  },
  {
    id: 4,
    ...
    description:
      'A web application that leverages machine learning models to generate unique images from text descriptions. Built with Python backend and React frontend for seamless user experience.',
    image: '',
    tech: ['React', 'Python', 'TensorFlow', 'FastAPI', 'AWS S3', 'Docker'],
    liveUrl: 'https://ai-image-gen-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/ai-image-generator',
    featured: false,
  },
  {
    id: 5,
    ...
    description:
      'Full-stack e-commerce solution with product management, cart functionality, payment integration, order tracking, and admin dashboard for inventory management.',
    image: '',
    tech: ['Next.js', 'Stripe', 'MongoDB', 'Tailwind', 'Vercel'],
    liveUrl: 'https://ecommerce-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/ecommerce',
    featured: false,
  },
  {
    id: 6,
    ...
    description:
      'Feature-rich messaging application with real-time communication, file sharing, group chats, and end-to-end encryption for secure conversations.',
    image: '',
    tech: ['React', 'Socket.io', 'Node.js', 'MongoDB', 'WebRTC'],
    liveUrl: 'https://chat-app-demo.vercel.app',
    githubUrl: 'https://github.com/utkarshsingh/chat-app',
    featured: false,
  },
];
    ...
    >
      ...
      <div className="container-custom relative z-10 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            A showcase of my best work, from full-stack applications to innovative web
            experiences
          </motion.p>
        </motion.div>
