...
const experiences = [
  {
    ...
    type: 'Internship',
    description:
      'Developed a comprehensive IPO tracking and analysis web application. Worked with production-level deployment pipelines and collaborated with senior developers on feature implementation.',
    achievements: [
    ...
    tech: ['Node.js', 'PostgreSQL', 'Express', 'REST APIs', 'AWS', 'Redis'],
    color: 'cyan' as const,
  },
  {
    id: 2,
    ...
    type: 'Freelance',
    description:
      'Delivered custom web solutions for clients across various industries. Managed end-to-end development from requirement gathering to deployment and maintenance.',
    achievements: [
    ...
    tech: ['React', 'Node.js', 'MongoDB', 'Next.js', 'TypeScript', 'Docker'],
  ...
  },
  {
    ...
    type: 'Part-time',
    description:
      'Active contributor to various open-source projects. Focus on React component libraries, Node.js utilities, and developer tools.',
    achievements: [
      'Contributed to 10+ open-source projects',
      'Fixed critical bugs and implemented new features',
      'Maintained documentation and helped new contributors',
      'Earned recognition from project maintainers',
    ],
    tech: ['React', 'TypeScript', 'Node.js', 'Git', 'GitHub Actions'],
...
const education = [
  {
    ...
    duration: '2021 - 2025',
    description: 'Focusing on software engineering, data structures, and machine learning.',
    achievements: ['CGPA: 8.5/10', 'Dean\'s List 2023', 'Hackathon Winner'],
  },
];
