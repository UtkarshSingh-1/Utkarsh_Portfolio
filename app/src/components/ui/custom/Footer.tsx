...
const socialLinks = [
  ...
  { icon: Mail, href: 'mailto:kshatriyautkarsh404@gmail.com', label: 'Email' },
];
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          >
            ...
            <p className="text-white/60 max-w-md mb-6">
              Full-stack developer focused on scalable web applications and clean system
              architecture.
            </p>
